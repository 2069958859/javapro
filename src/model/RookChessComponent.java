...
public class RookChessComponent extends ChessComponent {
    ...
    private static Image rb2;
    private static Image rw2;
    private Image rook2;
    private ChessComponent first;
    private ChessboardPoint chessComponent;
    ...
    public void loadResource() throws IOException {
        ...
        if(rb2==null){
            rb2 = ImageIO.read(new File("./images/rook-white2.png"));
        } if(rw2==null){
            rw2 = ImageIO.read(new File("./images/rook-black2.png"));
        }
...
//        g.drawImage(rookImage, 0, 0, getWidth() - 13, getHeight() - 20, this);
            g.drawImage(rook2, 0, 0, getWidth() , getHeight(), this);
            g.setColor(Color.BLACK);}
